...
@XModLib.HookUtils.methodHookExt(_inject_hooks_, AvatarInputHandler.DynamicCameras.ArtyCamera.ArtyCamera, '_ArtyCamera__interpolateStates', invoke=XModLib.HookUtils.HookInvoke.MASTER)
...
@XModLib.HookUtils.methodHookExt(_inject_hooks_, AvatarInputHandler.DynamicCameras.ArtyCamera.ArtyCamera, '_ArtyCamera__choosePitchLevel', invoke=XModLib.HookUtils.HookInvoke.MASTER)
...
@XModLib.HookUtils.propertyAddExt(_inject_hooks_, AvatarInputHandler.DynamicCameras.ArtyCamera.ArtyCamera, 'strategicAreaViewScaleMatrix', XModLib.HookUtils.PropertyAction.GET)
...
@XModLib.HookUtils.methodHookExt(_inject_hooks_, AvatarInputHandler.DynamicCameras.ArtyCamera.ArtyCamera, '_ArtyCamera__calculateIdealState', invoke=XModLib.HookUtils.HookInvoke.MASTER)
...
@XModLib.HookUtils.methodHookExt(_inject_hooks_, AvatarInputHandler.DynamicCameras.ArtyCamera.ArtyCamera, '_ArtyCamera__cameraUpdate')
...
@XModLib.HookUtils.methodHookExt(_inject_hooks_, AvatarInputHandler.DynamicCameras.ArtyCamera.ArtyCamera, 'enable', invoke=XModLib.HookUtils.HookInvoke.SECONDARY)
...
@XModLib.HookUtils.methodHookExt(_inject_hooks_, AvatarInputHandler.DynamicCameras.ArtyCamera.ArtyCamera, 'disable', invoke=XModLib.HookUtils.HookInvoke.PRIMARY)
...
def new_ArtyControlMode_handleKeyEvent(old_ArtyControlMode_handleKeyEvent, self, isDown, key, mods, event=None):
	...
	if not result:
		...
		mconfig = _config_['plugins']['advancedArty']
		if mconfig['enabled']:
