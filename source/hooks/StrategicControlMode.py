...
def new_StrategicControlMode_enable(self, *args, **kwargs):
	...
	if guiController is not None and not guiController.isUpdateActive:
		guiController.start()
		guiController.handleControlModeEnable(avatar_helpers.aim_global_binding.CTRL_MODE_NAME.STRATEGIC)
	return
...
def new_StrategicControlMode_disable(self, *args, **kwargs):
	...
	if guiController is not None and guiController.isUpdateActive:
		guiController.stop()
		guiController.handleControlModeDisable(avatar_helpers.aim_global_binding.CTRL_MODE_NAME.STRATEGIC)
	return
