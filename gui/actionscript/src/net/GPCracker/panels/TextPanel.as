package net.GPCracker.panels
{
	...
	import net.GPCracker.panels.components.PanelBackground;
	import net.GPCracker.panels.components.PanelBorder;
	import net.GPCracker.panels.components.PanelText;
	import net.GPCracker.meta.TextPanelMeta;
	import net.GPCracker.interfaces.ITextPanelMeta;

	public class TextPanel extends TextPanelMeta implements ITextPanelMeta
	{
